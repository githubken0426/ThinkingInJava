...
　　‘*’，’+'和’?'这三个符号，表示一个或N个字符重复出现的次数。它们分别表示“没有或更多”（[0,+∞]取整），
	“一次或更多”（[1,+∞]取整），“没有或一次”（[0,1]取整）。下面是几个例子：
...
　　“ \W ”匹配任何非单词字符。等价于“[^A-Za-z0-9_]”。
	 ...
	 * @param hex
	 */
	public static void split(String str,String hex){
		System.out.println(Arrays.toString(str.split(hex)));
	}
	
	public static void main(String[] args) {
		String str="Then,When you found the child,you must tell the police";
		//split(str," ");
		split(str,"n\\W+");
	}
}
