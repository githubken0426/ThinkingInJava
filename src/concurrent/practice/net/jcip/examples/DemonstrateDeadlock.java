...
import concurrent.practice.net.jcip.examples.DynamicOrderDeadlock.Account;
import concurrent.practice.net.jcip.examples.DynamicOrderDeadlock.DollarAmount;
