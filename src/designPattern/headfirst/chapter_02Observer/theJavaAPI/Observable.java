...
public class Observable {
	 ...
	 * longer changed. Each observer has its <code>update</code> method called
	 * with two arguments: this observable object and <code>null</code>. In
	 * other words, this method is equivalent to: <blockquote><tt>
	 ...
	 * <code>clearChanged</code> method to indicate that this object has no
	 * longer changed. Each observer has its <code>update</code> method called
	 * with two arguments: this observable object and the <code>arg</code>
	 * argument.
	 * 
	 * @param arg
	 *            any object.
