...
public class CopyCharacter implements java.io.Serializable, Comparable<Character>{
	/**
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
    ...
    public static enum UnicodeScript {
        ...
        private static HashMap<CopyString, Character.UnicodeScript> aliases;
        static {
            aliases = new HashMap<CopyString, Character.UnicodeScript>(128);
